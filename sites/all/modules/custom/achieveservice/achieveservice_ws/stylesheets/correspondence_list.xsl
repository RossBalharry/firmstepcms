...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:php="http://php.net/xsl" xmlns:fn="http://www.w3.org/2005/xpath-functions" version="1.0">
  ...
  <xsl:variable name="description">Correspondence List</xsl:variable>

  <xsl:template match="/">
    <response>
      <title><h1 id="correspondence-history-header">Correspondence History</h1></title>
      <content>
        <xsl:apply-templates select="/feed/ServicesResponseEnvelope/CTax/correspondence">
